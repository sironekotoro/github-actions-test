...
# --- agent patch validation sub-categories ---
# The top-level AGENT_PATCH_INVALID is retained; the sub-category below
# provides precise diagnostics by being written to the failure file instead
# when one of the specific conditions is detected.
CAT_AGENT_PATCH_INVALID="AGENT_PATCH_INVALID"
CAT_PATCH_NO_CHANGES="AGENT_PATCH_NO_CHANGES"
CAT_PATCH_EMPTY="AGENT_PATCH_EMPTY"
CAT_PATCH_PARSE_FAILED="AGENT_PATCH_PARSE_FAILED"
CAT_PATCH_VALIDATION_FAILED="AGENT_PATCH_VALIDATION_FAILED"
